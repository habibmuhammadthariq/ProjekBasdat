...
public class viewPenceramah extends JFrame{

    private JLabel lId = new JLabel("ID Penceramah");
    ...
    public void addDaftarListener(ActionListener btnDaftarListener){
        btnDaftar.addActionListener(btnDaftarListener);
    }
